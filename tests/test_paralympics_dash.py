...
# # chromedriver_location = Path(__file__).parent.joinpath('chromedriver-win64','chromdriver.exe')
# # driver = webdriver.Chrome(chromedriver_location)
driver = webdriver.Chrome("C:/Users/asus/Downloads/chromedriver-win64 (2)/chromedriver-win64/chromedriver.exe")
